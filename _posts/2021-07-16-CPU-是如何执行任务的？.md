![](https://upload-images.jianshu.io/upload_images/6943526-700f16733540b00e.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-d19773abd1cfc68c?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-70b22b464abe8e89?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-d6c2882aedd465b1?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

从上图也可以看到，从上往下，存储设备的容量会越大，而访问速度会越慢。至于每个存储设备的访问延时，你可以看下图的表格：

![](https://upload-images.jianshu.io/upload_images/6943526-16162146100e4f59?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-8af1367ec6372ed8?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-6562fffd826896e0?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-c24c912ae8ac7039?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

②. 1 号核心读取变量 A，由于 CPU 从内存读取数据到 Cache 的单位是 Cache Line，也正好变量 A 和 变量 B 的数据归属于同一个 Cache Line，所以 A 和 B 的数据都会被加载到 Cache，并将此 Cache Line 标记为「独占」状态。

![](https://upload-images.jianshu.io/upload_images/6943526-4abdd547af511326?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-a34d54dc362ce1a0?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

④. 1 号核心需要修改变量 A，发现此 Cache Line 的状态是「共享」状态，所以先需要通过总线发送消息给 2 号核心，通知 2 号核心把 Cache 中对应的 Cache Line 标记为「已失效」状态，然后 1 号核心对应的 Cache Line 状态变成「已修改」状态，并且修改变量 A。

![](https://upload-images.jianshu.io/upload_images/6943526-b106ba841a1b0394?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

⑤. 之后，2 号核心需要修改变量 B，此时 2 号核心的 Cache 中对应的 Cache Line 是已失效状态，另外由于 1 号核心的 Cache 也有此相同的数据，且状态为「已修改」状态，所以要先把 1 号核心的 Cache 对应的 Cache Line 写回到内存，然后 2 号核心再从内存读取 Cache Line 大小的数据到 Cache 中，最后把变量 B 修改到 2 号核心的 Cache 中，并将状态标记为「已修改」状态。

![](https://upload-images.jianshu.io/upload_images/6943526-05219af03c1875a9?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-100de024ae69619e?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-882313bae9c6034b?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

结构体里的两个成员变量 a 和 b 在物理内存地址上是连续的，于是它们可能会位于同一个 Cache Line 中，如下图：

![](https://upload-images.jianshu.io/upload_images/6943526-46b212626bec270c?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

所以，为了防止前面提到的 Cache 伪共享问题，我们可以使用上面介绍的宏定义，将 b 的地址设置为 Cache Line 对齐地址，如下：

![](https://upload-images.jianshu.io/upload_images/6943526-db21ff361933a827?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

这样 a 和 b 变量就不会在同一个 Cache Line 中了，如下图：

![](https://upload-images.jianshu.io/upload_images/6943526-ddbd3a4f745e24f0?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-5ab24d64e8b792dc?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-ffa6d1c088062f1e?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-dcb45feecd909427?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-46a8ee3fc51f31e8?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-7d9cf753a1e19c13?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-d366da5c1b65df7f?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-ba0710c056ef9879?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-8ee50b674541ff53?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

如果想修改已经运行中的任务的优先级，则可以使用 `renice` 来调整 nice 值：

![](https://upload-images.jianshu.io/upload_images/6943526-0f71bc8d7faf708e?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

nice 调整的是普通任务的优先级，所以不管怎么缩小 nice 值，任务永远都是普通任务，如果某些任务要求实时性比较高，那么你可以考虑改变任务的优先级以及调度策略，使得它变成实时任务，比如：

![](https://upload-images.jianshu.io/upload_images/6943526-7b7f4c34be826c34?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/6943526-dc2979f342d037c4.gif?imageMogr2/auto-orient/strip)
