工作中经常会有搜索的需求，最常用的就是模糊搜索`%+like+%`，在InnoDB中使用  "like%xx" 会导致索引失效，会大大降低搜索的效率。
...
![](https://upload-images.jianshu.io/upload_images/6943526-7a79f13dcbf4e2a4?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
