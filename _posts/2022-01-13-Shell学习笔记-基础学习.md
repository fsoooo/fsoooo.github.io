![](https://upload-images.jianshu.io/upload_images/6943526-f1f78888270a1323.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
**命令替换**命令替换与变量替换差不多，都是用来重组命令行的，先完成引号里的命令行，然后将其结果替换出来，再重组成新的命令行。
执行命令：
```
